...
void NewProjectAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    Delay.DelayBFSize = 5023 * SamplesForBufferSize; // 5000 is the total MS the slider permits in buffer size, 5023 avoid some glitch sounds
...
void NewProjectAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
   ...
   // !!!!!!! BUPProc é o backup da versão antiga desse método !!!!!!!
    ...
    Delay.DelayBFDataSizeView = DelayBFDataSize;
    //Delay.ModFB = Delay.ModulateNum() * Delay.FeedBNum; Delay.ModMS = Delay.ModulateNum() * Delay.MSNum;
    ...
    for (int channel = 0; channel < totalNumInputChannels; ++channel)
    {
        ...
        //float* BFDataWritePointer = buffer.getWritePointer(channel);
        //float* DelayBFDataWritePointer = Delay.DelayBuffer.getWritePointer(channel);
